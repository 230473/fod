...
**Performance peor caso** (overflow hasta la raíz):
- h lecturas + 2h+1 escrituras (2 escrituras por nivel más la raíz).

**Estudios realizados**:
- M = 10 → 25% de las inserciones producen división.
- M = 100 → solo 2% de las inserciones producen división.
...
**Performance**:
- Mejor caso: h lecturas + 1 escritura.
- Peor caso: 2h-1 lecturas + h+1 escrituras (concatenación que decrementa la altura).
