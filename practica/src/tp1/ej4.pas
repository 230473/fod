...
//    Tener en cuenta que no se debe agregar al archivo un empleado con un número de empleado ya 
//    registrado (control de unicidad).
...
begin
    ...
    { Busca el empleado en el archivo y devuelve su posicion o -1 si no existe }
...
begin
    ...
    { Verifica que no exista un empleado con el mismo numero }
...
begin
    ...
    { Exporta todos los registros en formato texto }
...
begin
    ...
    seek(archivo_origen_binario, 0);
    { Exporta solo los registros con DNI = 0 }
    while not eof(archivo_origen_binario) do begin
        read(archivo_origen_binario, empleado_a_exportar);
